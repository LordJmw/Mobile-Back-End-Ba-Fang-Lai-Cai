...
abstract class AppLocalizations {
  ...
  /// No description provided for @twatchAdGetDisc.
  ///
  /// In en, this message translates to:
  /// **'Watch the ad to get 2% off'**
  String get twatchAdGetDisc;

  /// No description provided for @watchAdGetDisc.
  ///
  /// In en, this message translates to:
  /// **'Watch Ad!'**
  String get watchAdGetDisc;
  ...
  /// No description provided for @enableNotificationForPremium.
  ///
  /// In en, this message translates to:
  /// **'Enable notifications so you don’t forget your premium expiry'**
  String get enableNotificationForPremium;

  /// No description provided for @enableNotificationAction.
  ///
  /// In en, this message translates to:
  /// **'Enable'**
